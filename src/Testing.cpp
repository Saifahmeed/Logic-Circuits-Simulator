...
int main() {
    ...
    for (int n = 1; n <= 5; n++) {
        ...
        string tests_folder = "../tests/" + to_string(n) + "/";
        string components_filename = tests_folder + "circuit-" + to_string(n) + ".lib";
        string circuit_filename = tests_folder + "circuit-" + to_string(n) + ".circ";
        string stimulus_filename = tests_folder + "circuit-" + to_string(n) + ".stim";
